    ...
    <section class="seccion-listado-sedes py-5">
        <div class="container">
            ...
            <div class="mapa-placeholder mb-5">
                <img src="<?php echo e(asset('img/mapa.png')); ?>" alt="Mapa de sedes" class="img-fluid w-100">
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col">
