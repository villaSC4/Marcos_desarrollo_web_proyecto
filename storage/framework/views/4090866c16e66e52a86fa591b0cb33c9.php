...
<?php $__env->startPush('styles'); ?>
    ...
    <style>
        ...
        .modal-back { 
            ...
            width: 100%; 
            height: 100%; 
            background: rgba(15, 23, 42, 0.6); /* Fondo oscuro azulado sutil */
        ...
        .modal-content { 
            background: #ffffff; 
            padding: 40px 30px; 
            border-radius: 24px; /* Esquinas muy suaves */
            text-align: center; 
            max-width: 420px; 
            width: 90%; 
        ...
        /* Texto descriptivo dentro del modal */
        .modal-content p {
            color: #64748b;
            font-size: 1rem;
            line-height: 1.6;
        ...
        /* Resaltados dentro del texto del modal */
        ...
        .btn-cancelar { 
            background-color: #f1f5f9; /* Gris claro sutil */
            color: #64748b; 
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\Marcos_Raquel\Marcos_desarrollo_web_proyecto\resources\views/pages/canjes.blade.php ENDPATH**/ ?>