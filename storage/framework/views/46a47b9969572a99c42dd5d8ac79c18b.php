...
<div class="socios-hero-section py-5 text-center position-relative overflow-hidden">
    <div class="decoracion-hojas">
        <img src="<?php echo e(asset('img/deco1.png')); ?>" alt="Decoración" class="deco-hoja-left">
        <img src="<?php echo e(asset('img/deco2.png')); ?>" alt="Decoración" class="deco-hoja-right">
    </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 justify-content-center">
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    ...
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/tottus.png')); ?>" alt="Logo Tottus" class="img-fluid partner-logo">
                    </div>
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    ...
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/plazavea.jpg')); ?>" alt="Logo Plaza Vea" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner socio-badge">Socio Comercial</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/vivanda.jpg')); ?>" alt="Logo Vivanda" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner socio-badge">Socio Comercial</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/makro.jpg')); ?>" alt="Logo Makro" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 justify-content-center">
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    ...
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/MUNILIMA.webp')); ?>" alt="Municipalidad de Lima" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    ...
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/SanBorja.webp')); ?>" alt="Municipalidad de San Borja" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner aliado-badge">Aliado Activo</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/MUNILINCE.webp')); ?>" alt="Municipalidad de Lince" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner aliado-badge">Aliado Activo</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/MUNIRIMAC.webp')); ?>" alt="Municipalidad del Rímac" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner aliado-badge">Aliado Activo</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/MUNIVICTORIA.webp')); ?>" alt="Municipalidad de La Victoria" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
            ...
            <div class="col">
                <div class="card h-100 partner-card shadow-sm border-0">
                    <span class="badge-partner aliado-badge">Aliado Activo</span>
                    <div class="logo-container d-flex align-items-center justify-content-center p-4">
                        <img src="<?php echo e(asset('img/MUNISJL.webp')); ?>" alt="Municipalidad de San Juan de Lurigancho" class="img-fluid partner-logo">
                    </div>
                    <div class="card-body pt-0 text-center">
    ...
    <section class="cta-socios text-center p-5 rounded-4 mt-5 shadow">
        <div class="cta-content position-relative z-1 mx-auto" style="max-width: 600px;">
            ...
            <div class="d-flex flex-wrap gap-3 justify-content-center">
                <a href="<?php echo e(route('unete')); ?>" class="btn btn-light-custom px-4 py-3 fw-bold rounded-pill shadow-sm">
                    Quiero Registrarme
                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Documents\marcos_web\Marcos_desarrollo_web_proyecto\Marcos_desarrollo_web_proyecto\resources\views/pages/socios.blade.php ENDPATH**/ ?>